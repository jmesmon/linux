 ...
 */
#define EVENT_ATTR_NAME__(name, r_name, c_name) name ## _event_attr_ ## r_name ## _ ## c_name
#define EVENT_ATTR_NAME_(name, r_name, c_name) EVENT_ATTR_NAME__(name, r_name, c_name)
#define EVENT_ATTR_NAME(r_name, c_name) EVENT_ATTR_NAME_(NAME_LOWER, r_name, c_name)
...
__maybe_unused static struct attribute *hv_gpci_event_attrs[] = {
#include REQUEST_FILE
	NULL
};
